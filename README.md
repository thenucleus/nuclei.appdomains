...
The 'Nuclei.AppDomains' assembly contains a set of classes and interfaces to assist with the creation and configuration of a new AppDomain.


## Installation instructions

All libraries are available on [NuGet.org](https://www.nuget.org/packages/Nuclei.AppDomains/).
